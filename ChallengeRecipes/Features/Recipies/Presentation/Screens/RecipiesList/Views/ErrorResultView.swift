...
class ErrorResultView: UIView {
    ...
    private let messageLabel: UILabel = {
        ...
        label.text = "Tenemos problemas en obtener las recetas, intenta nuevamente"
        return label
    }()
...
private extension ErrorResultView {
    func setupUI() {
        setupImageView()
        setupMessageLabel()
        setupRetryButton()
